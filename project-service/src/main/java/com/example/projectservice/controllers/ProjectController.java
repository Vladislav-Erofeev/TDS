...
public class ProjectController {
    ...
    @GetMapping("/invite")
    public void attachPersonToProject(@RequestParam("token") String hash,
        ...
        projectService.attachProjectToPerson(principal.getAttribute("id"), inviteGenerator.validateHash(hash));
    }
